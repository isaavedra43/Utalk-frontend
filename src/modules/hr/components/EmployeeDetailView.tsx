                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900">
                          {employee?.position?.endDate ? safeFormatDate(employee.position.endDate) : 'Actualmente en el puesto'}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900">
                          {employee?.contract?.endDate ? safeFormatDate(employee.contract.endDate) : 'Indefinido'}
                        </p>
                      </div>
                      <div>
                          ...
                          {(() => {
                            try {
                              if (employee?.contract?.salary) {
                                return `$${employee.contract.salary.toLocaleString()} ${employee.contract.currency || 'MXN'}`;
                              } else if (employee?.salary?.baseSalary) {
                                return `$${employee.salary.baseSalary.toLocaleString()} ${employee.salary.currency || 'MXN'}`;
                              } else {
                                return 'N/A';
                              }
                            } catch (error) {
                      ...
                      <div>
                        ...
                        <p className="text-gray-900">
                          {(() => {
                            try {
                              return employee?.sbc ? `$${employee.sbc.toLocaleString()}` : 'N/A';
                            } catch (error) {
                              console.error('Error al formatear SBC:', error);
                              return 'N/A';
                            }
                          })()}
                        </p>
