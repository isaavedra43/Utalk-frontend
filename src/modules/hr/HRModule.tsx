...
const HRModule: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'attendance', name: 'Asistencia', icon: CheckCircle },
        ...
        return (
          <div className="p-6">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Módulo de Nómina</h2>
              <p className="text-gray-600 mb-6">
                El módulo de nómina está en desarrollo. Próximamente podrás gestionar 
                la nómina general e individual de los empleados.
              </p>
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <p className="text-green-800 text-sm">
                  <strong>Nota:</strong> Este módulo se implementará en la carpeta @Payroll/
                </p>
              </div>
            </div>
          </div>
