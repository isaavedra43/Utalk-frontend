    ...
    <>
      ...
      <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 z-50 py-2">
        ...
        >
          ...
          <div>
            <p className="text-sm font-medium text-gray-900">Exportar a PDF</p>
            <p className="text-xs text-gray-500">Generar documento imprimible</p>
          </div>
        </button>
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Formato CSV para Excel</p>
          </div>
        </button>
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Compartir vía apps</p>
          </div>
        </button>
      </div>
    </>
