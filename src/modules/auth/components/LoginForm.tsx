    ...
    <div className="space-y-6">
      ...
      {import.meta.env.VITE_DEV_MODE === 'true' && (
        ...
        >
          <button
            ...
            disabled={isLoading}
            className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white h-10 font-semibold transition-all duration-300 shadow-lg hover:shadow-xl relative overflow-hidden group rounded-lg flex items-center justify-center gap-2"
          >
      ...
      >
        ...
        <div className="relative flex justify-center text-sm">
                     <span className="px-2 bg-white text-gray-500 text-xs">Or continue with email</span>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            disabled={isLoading}
            className={`w-full px-3 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${
              errors.email 
        ...
        >
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 hover:from-blue-700 hover:via-purple-700 hover:to-blue-800 text-white h-10 font-semibold transition-all duration-300 shadow-lg hover:shadow-xl relative overflow-hidden group rounded-lg"
