...
export const BACKEND_ENDPOINTS = {
    ...
    CONVERSATION_MESSAGE: (convId: string, msgId: string) => `/conversations/${convId}/messages/${msgId}`,
    CONVERSATION_MESSAGE_READ: (convId: string, msgId: string) => `/conversations/${convId}/messages/${msgId}/read`,
...
const BACKEND_MODELS = {
    ...
    message: ['id', 'conversationId', 'content', 'senderIdentifier', 'recipientIdentifier', 'direction', 'type', 'status', 'timestamp'],
