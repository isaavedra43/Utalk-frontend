...
class PermissionManager {
     ...
     */
    validateAction(action: string, requiredPermission: Permission, context?: Record<string, unknown>): boolean {
...
export const canAssignConversations = (): boolean =>
    permissionManager.canAssignConversations();

export const canEditContacts = (): boolean =>
    permissionManager.canEditContacts();

export const canDeleteMessages = (): boolean =>
    permissionManager.canDeleteMessages();

export const canManageFiles = (): boolean =>
    permissionManager.canManageFiles();

export const canViewStats = (): boolean =>
    permissionManager.canViewStats();
...
export const isAgent = (): boolean =>
    permissionManager.isAgent();

export const isViewer = (): boolean =>
    permissionManager.isViewer();
...
export const validateAction = (action: string, requiredPermission: Permission, context?: Record<string, unknown>): boolean =>
    permissionManager.validateAction(action, requiredPermission, context); 