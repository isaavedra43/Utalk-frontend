...
export const logError = (message: string, context?: string, error?: Error, data?: LogData) =>
...
export const logWarnWithContext = (message: string, context: string, data?: LogData) =>
  logger.warn(message, context, data);
